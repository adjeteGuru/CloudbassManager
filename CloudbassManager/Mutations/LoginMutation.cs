...
namespace CloudbassManager.Mutations
{
    ...
    public class LoginMutation
    {
        ...
        //  LoginInput input,
        //  [Service] CloudbassContext db, [Service]IUserRepository userRepository, IEmployeeRepository employeeRepository)
        //{
        ...
        //    User user = await db.Users.FirstOrDefaultAsync(t => t.Name == input.Email);
